<?php
/*
Copyright 2014  Media-Street LTD  (email : mail@media-street.co.uk)
...
class ModSspHelper
{
    ...
    **  more secure than the other PSPs who don't both encrypting their forms at all                                      */
    ...
    function encryptAndEncode($strIn,$strEncryptionType,$strEncryptionPassword,$module_id) {
    ...
    function decodeAndDecrypt($strIn,$strEncryptionPassword,$module_id) {
